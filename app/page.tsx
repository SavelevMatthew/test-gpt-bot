            ...
            <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-12 sm:mt-20">
                ...
                <div className="max-w-xl w-full">
                    ...
                    <textarea
                        ...
                        placeholder={
                            "В подъезде прорвало трубу, которую обслуживает ресурсо-снабжающая организация, в связи с чем был нанесен ущерб лестничной клетке, которую обслуживаю я. Могу ли я потребовать с нее деньги на ремонт?"
                        }
                    />
